  ...
  const notifications = [
    {
      ...
      icon: ExternalLink,
      badge: "New Platform",
      title: "Capimax BRX — Tokenization Exchange",
      description: "Discover Capimax BRX, our blockchain-powered real estate tokenization exchange. Secure, transparent, and accessible tokenized property ownership.",
      link: "https://www.capimaxbrx.com",
      linkText: "Visit Capimax BRX",
      isExternal: true,
